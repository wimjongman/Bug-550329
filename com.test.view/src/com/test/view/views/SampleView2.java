...
public class SampleView2 extends ViewPart implements ISelectionListener {
	...
	public void createPartControl(Composite parent) {
		...
		getSite().getPage()
				.addSelectionListener(SelectionListenerFactory.createVisibleSelfMutedListener(this, this));
		makeActions();
		hookContextMenu();
	...
	public void selectionChanged(IWorkbenchPart pPart, ISelection pSelection) {
		if (getSite().getPage().isPartVisible(this)) {
			System.out.println("View 2: Selection received: " + pPart.toString() + " : " + pSelection.toString());
		} else {
			System.err.println("View 2: Selection received: " + pPart.toString() + " : " + pSelection.toString());
		}
	}

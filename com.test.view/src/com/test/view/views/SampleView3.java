...
public class SampleView3 extends ViewPart implements ISelectionListener {
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				SampleView3.this.fillContextMenu(manager);
			}
		});
	...
	public void selectionChanged(IWorkbenchPart pPart, ISelection pSelection) {
		if (getSite().getPage().isPartVisible(this)) {
			System.out.println("View 3: Selection received: " + pPart.toString() + " : " + pSelection.toString());
		} else {
			System.err.println("View 3: Selection received: " + pPart.toString() + " : " + pSelection.toString());
		}
	}
}

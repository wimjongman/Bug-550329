...
public class SampleView4 extends ViewPart implements ISelectionListener {
	...
	public void selectionChanged(IWorkbenchPart pPart, ISelection pSelection) {
		if (getSite().getPage().isPartVisible(this)) {
			System.out.println("View 4: Selection received: " + pPart.toString() + " : " + pSelection.toString());
		} else {
			System.err.println("View 4: Selection received: " + pPart.toString() + " : " + pSelection.toString());
		}
	}
}
